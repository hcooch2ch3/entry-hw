...
Module.prototype.checkInitialData = function(data, config) {
	// 이름 필드는 사용자 임의/다국어 가변값이라 콤마·CR/LF가 섞이면 앞-인덱스가 밀린다.
	// 종단 CR/LF만 제거하고 콤마로만 분리한 뒤 고정 구조(모델/변형/주소)를 뒤에서 집는다.
	// 실물 캡처(FF01,Hamster,04,05,ADDR)로 variant 2-hex·주소 12-hex·trailing 없음 확인됨.
